...
| 分野 | 項目 | 状態 | 日付 |
| --- | --- | --- | --- |
| ネットワーク | 1 ネットワーク構成 | done | 9/16 |
| ネットワーク | 2 TCP/IP | done | 9/19 |
| ネットワーク | 3 LAN |  ||
| ネットワーク | 4 ネットワーク応用 |  ||
| セキュリティ | 1 情報セキュリティとマネジメント | done ||
| セキュリティ | 2 盗聴・改ざん対策 | done ||
| セキュリティ | 3 不正アクセス対策 | done | 9/17 |
| セキュリティ | 4 脆弱性対策 |  ||
| セキュリティ | 5 マルウェア対策 |  ||
| セキュリティ | 6 サービス妨害対策 |  ||
| データベース | 1 データモデル | - ||
| データベース | 2 正規化 | done | 9/17 |
| データベース | 3 SQL | - |
| データベース | 4 データベース応用 | done | 9/17 |
|システムアーキテクチャ|1.方式設計・機能分割 | done | 9/26 |
|システムアーキテクチャ|2.提案依頼書 | done | 9/26 |
|システムアーキテクチャ|3.要求分析 | done | 9/26 |
|システムアーキテクチャ|4.信頼性・性能 | done | 9/26 |
|システムアーキテクチャ|5.Web技術 | done | 9/26 |
...
<details><summary>📗FE_A:講座テキスト書き起こし 2026/09/24 update</summary>
...
| テクノロジ | ソフトウェア | done | 9/24 |
| テクノロジ | ユーザインタフェース | - ||
| テクノロジ | ソフトウェア開発管理技術 | done | 9/24 |
...
<details><summary>📕 FE 科目B ・ 10問</summary>

`████████░░` 80%　8/10問 · 49分

| 教材 | パーフェクトラーニング技術評論社06 / 3_対策問題①_B , 4_対策問題②_B |
|---|---|
| 分野 | アルゴリズム , セキュリティ |
| 最長 | アルゴリズム No.11（16分） |
| 誤答 | アルゴリズム No.11 , 14 |
...
| 教材 | 大原練習問題 / 第3部 代表的なアルゴリズム① , 第4部 データ構造とアルゴリズム② , 第5部 代表的なアルゴリズム② |
|---|---|
| 分野 | 探索（サーチ） , リスト , 木 , ハッシュ法 |
| 最長 | 探索（サーチ） No.43（35分） |
| 誤答 | 探索（サーチ） , リスト No.40 , 46 , 48 , 50 |
...
| 教材 | 大原練習問題 / 第2部 データ構造とアルゴリズム① |
|---|---|
| 分野 | 配列 |
| 最長 | 配列 No.31（21分） |
| 誤答 | 配列 No.21 , 22 , 23 , 25 , 31 , 33 , 36 , 38 , 39 |
